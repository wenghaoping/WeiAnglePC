<template>
  <div id='mailProjectDetail_type1' v-loading.fullscreen="loading" element-loading-text="拼命加载中" class="container">
        ...
        <div class="white">
          ...
          <div class='userCard flex'>
            ...
            <div class="userName" style="margin-top: 1rem;line-height: 20px;">
              ...
              <div class="careerAndcompany size_12 color_6">{{projectUser.user_career}}·{{projectUser.user_company}}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="white1" style="margin-top: 16px">
          <div class="project_intro">
            ...
            <div class="intro_tags flex" v-if='projectDetail.tag.length !== 0' style="margin-bottom: .625rem;">
              <div class="tag" style="margin-top: 0;" v-if="tag.type === 0" v-for="tag in projectDetail.tag">
                {{tag.tag_name}}
              </div>
            </div>
        ...
        <div class="white1" v-if="projectDetail.pro_history_finance.length !== 0" style="margin-top: 16px">
          <div class="financing">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.pro_history_finance.length >3">
                全部&nbsp;({{projectDetail.pro_history_finance.length}})
              </div>
            </div>
            <div class="pro_history_finance" v-for="(finance, index) in projectDetail.pro_history_finance">
              ...
              <div class='flex' style="margin-top: 6px;">
                <div class="finance_left financingStage size_14 color_3 weight">
                  {{finance.belongs_to_stage.stage_name}}
                </div>
          ...
          <div class="financingInfo">
            ...
            <div class="financingDetail flex">
              <div class="financingDetailItem">
                ...
                <div class="size_13" style="color: #f6a623;margin-top: .4rem;">
                  {{projectDetail.pro_scale.scale_money || '暂未透露'}}
                </div>
              </div>
              <div class="financingDetailItem">
                <div class="size_11 color_6">投后股份</div>
                <div class="size_13" style="color: #f6a623;margin-top: .4rem;">
                  {{projectDetail.pro_finance_stock_after || '暂未透露'}}
                </div>
              </div>
              <div class="financingDetailItem">
                <div class="size_11 color_6">估值</div>
                <div class="size_13" style="color: #f6a623;margin-top: .4rem;">
                  {{projectDetail.pro_finance_value || '暂未透露'}}
                </div>
              </div>
            </div>
        ...
        <div class="white1" v-if="projectDetail.pro_develop.length !== 0" style="margin-top: 16px;">
          <div class="milepost">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.pro_develop.length >3">
                全部&nbsp;({{projectDetail.pro_develop.length}})
              </div>
            </div>
    ...
    <getContact class="getContact" :dialogVisible='dialogVisible' :project_id='project_id'
                @closeGetContact='closeGetContact'></getContact>
    <!--查看BP方式选择-->
    <el-dialog
      title="请选择查看方式"
