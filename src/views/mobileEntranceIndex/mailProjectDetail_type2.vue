<template>
  <div id='mailProjectDetail_type2' v-loading.fullscreen="loading" element-loading-text="拼命加载中" class="container">
        ...
        <div class="white1" v-if="projectDetail.product_list.total_num !== 0" style="margin-top: 16px">
          <div class="brandList">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.product_list.length >3">
                全部&nbsp;({{projectDetail.product_list.total_num}})
              </div>
            </div>
        ...
        <div class="white1" v-if="projectDetail.history_finance.total_num !== 0" style="margin-top: 16px">
          <div class="financing">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.history_finance.length >3">
                全部&nbsp;({{projectDetail.history_finance.total_num}})
              </div>
            </div>
        ...
        <div class="white1" v-if="projectDetail.member_list.total_num !== 0" style="margin-top: 16px">
          <div class="coreTeam">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.member_list.length >3">
                全部&nbsp;({{projectDetail.member_list.total_num}})
              </div>
            </div>
            <div class="teamMember" v-for='member in projectDetail.member_list.list'>
              ...
              <div class="bottom flex">
                <div class="left"></div>
                <div class="right size_12 color_9"
                     style="line-height: 1rem;background: #fafafa;padding: .75rem;margin-left:4.2rem;">
        ...
        <div class="white1" v-if="projectDetail.milestone_list.total_num !== 0" style="margin-top: 16px">
          <div class="milepost">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.milestone_list.length >3">
                全部&nbsp;({{projectDetail.milestone_list.total_num}})
              </div>
            </div>
            <div class="pro_develop size_14 flex" style="flex-wrap: nowrap;"
                 v-for='(milestone,index) in projectDetail.milestone_list.list'>
        ...
        <div class="white1" v-if="projectDetail.competition_company.total_num !== 0" style="margin-top: 16px;cursor: pointer;">
          <div class="competition_company_list">
            <div class="main_title flex">
              ...
              <div class="showAll" v-if="projectDetail.competition_company.length >3">
    ...
    <getContact class="getContact" :dialogVisible='dialogVisible' :project_id='project_id'
                @closeGetContact='closeGetContact'>
